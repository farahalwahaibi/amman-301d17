...
// Refactor sum function into an arrow function :

let sumAsArrowWay = (a, b, c, d) => `${a + b + c + d}`;
console.log(sumAsArrowWay(1, 2, 3, 4));
...
// Refactor objectLit function into an arrow function :

let objectLitAsArrowWay = () => ({
  key1: 'value1',
  key2: 'value2',
  key3: 'value3',
});
console.log(objectLitAsArrowWay());
...
// Refactor sumAndProduct function into an arrow function :

let sumAndProductAsArrowWay = (a, b) => {
  let sum = a + b ;
  let product = a * b ;
  return [sum, product];
}
console.log(sumAndProductAsArrowWay(3, 9));
...
// Refactor message function into an arrow function :

let messageAsArrowWay = name => `Hello, ${name}!`;
console.log(messageAsArrowWay('Allie'));
...
// When we invoked joe.scope(), this will refer to the student object (because it's a normal function) .
